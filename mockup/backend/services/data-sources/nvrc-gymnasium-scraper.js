...
class NVRCGymnasiumScraper {
    ...
    async scrapeGymnasiumSchedules() {
        try {
            ...
            // Add some sample NVRC drop-in games if none were found (for demo purposes)
            if (dropInGames.length === 0) {
                const sampleGames = [
                    {
                        ...
                        venue: {
                            ...
                            coordinates: { lat: 49.3234, lng: -123.1043 }
                        }
                    },
                    {
                        centre: 'Ron Andrews Community Recreation Centre',
                        sport: 'volleyball',
                        day: 'Thursday',
                        time: '8:00pm-10:00pm',
                        ...
                        venue: {
                            ...
                            address: '931 Lytton St, North Vancouver',
                            coordinates: { lat: 49.3234, lng: -123.0831 }
                        }
                    },
                    {
                        centre: 'Harry Jerome Community Recreation Centre',
                        sport: 'badminton',
                        day: 'Friday',
                        time: '6:30pm-8:30pm',
                        ...
                        venue: {
                            ...
                            coordinates: { lat: 49.3267, lng: -123.0688 }
                        }
                    },
                    {
                        centre: 'John Braithwaite Community Centre',
                        sport: 'pickleball',
                        day: 'Wednesday',
                        time: '10:00am-12:00pm',
                        type: 'Senior Drop-in Pickleball',
                        venue: {
                            name: 'John Braithwaite Community Centre',
                            address: '145 West 1st St, North Vancouver',
                            coordinates: { lat: 49.3140, lng: -123.0753 }
                        }
                    }
                ];
                dropInGames.push(...sampleGames);
                console.log('Added sample NVRC drop-in games for demo');
                
                // Save the sample games
                await this.saveDropInGames(dropInGames);
            }
